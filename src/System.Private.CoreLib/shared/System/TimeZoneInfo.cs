...
#pragma warning restore 0420
        ...
        public bool HasSameRules(TimeZoneInfo other)
        {
            ...
            bool sameRules = (currentRules == null && otherRules == null) ||
        ...
        {
            return GetUtcOffsetFromUtc(time, zone, out bool isDaylightSavings);
        }
        ...
        {
            return GetUtcOffsetFromUtc(time, zone, out isDaylightSavings, out bool isAmbiguousLocalDst);
        }
        ...
        {
            TimeZoneInfoResult result = TryGetTimeZoneFromLocalMachine(id, out TimeZoneInfo match, out e);
